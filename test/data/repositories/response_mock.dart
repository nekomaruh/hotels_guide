    ...
    "moteis": [
      {
        ...
        "bairro": "ChÃ¡cara Flora - SÃ£o Paulo",
        "distancia": 28.27,
        "qtdFavoritos": 0,
        "suites": [
          {
            "nome": "SuÃ­te Marselha s/ garagem privativa",
            "qtd": 1,
            ...
            "itens": [
              ...
              {"nome": "TV a cabo"},
              {"nome": "TV LED 32''"},
              {"nome": "iluminaÃ§Ã£o por leds"},
              {"nome": "garagem coletiva"},
              {"nome": "som AM/FM"},
              {"nome": "3 canais erÃ³ticos"},
              {"nome": "bluetooth"},
              {"nome": "espelho no teto"},
              {"nome": "acesso Ã  suÃ­te via escadas"},
              {"nome": "frigobar"},
          ...
          {
            "nome": "SuÃ­te Nantes s/ garagem privativa",
            "qtd": 2,
            "exibirQtdDisponiveis": true,
            "fotos": [
          ...
          },
          {
            ...
            "itens": [
              ...
              {"nome": "3 canais erÃ³ticos"},
              {"nome": "smart TV"},
              {"nome": "automaÃ§Ã£o via tablet"},
              {"nome": "bluetooth"},
              {"nome": "espelho no teto"},
              {"nome": "som AM/FM"},
              {"nome": "banheira de hidromassagem"},
              {"nome": "poltrona erÃ³tica"},
              {"nome": "garagem privativa"},
              {"nome": "frigobar"},
              {"nome": "WI-FI"},
              {"nome": "ar-condicionado split"},
          ...
          },
          {
            ...
            "itens": [
              {"nome": "TV a cabo"},
              {"nome": "iluminaÃ§Ã£o de led"},
              {"nome": "ducha dupla"},
              {"nome": "automaÃ§Ã£o via tablet"},
              {"nome": "Alexa"},
              {"nome": "algemas na cama"},
              {"nome": "acessÃ³rios erÃ³ticos"},
              {"nome": "TV Smart com NetFlix"},
              {"nome": "bluetooth"},
              {"nome": "vitrine erÃ³tica"},
              {"nome": "jogo de dados erÃ³ticos"},
              {"nome": "hidro spa"},
              {"nome": "ambiente erÃ³tico"},
              {"nome": "X erÃ³tico"},
              {"nome": "garagem privativa"},
